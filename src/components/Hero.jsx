import heroImg from '../assets/project 4/3-3-3.png'

export default function Hero() {
  return (
    <section className="bg-dark min-h-screen grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-8 items-center px-6 md:px-24 py-16 overflow-hidden">
      ...
      <div className="flex flex-col gap-6">
        ...
        <h1 className="text-cream text-4xl md:text-5xl font-medium leading-tight tracking-tight">
